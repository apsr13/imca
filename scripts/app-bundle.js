  ...
  var EditUserController = exports.EditUserController = (_dec = (0, _aureliaFramework.transient)(), _dec2 = (0, _aureliaFramework.inject)(_server.Server, _aureliaFramework.NewInstance.of(_aureliaValidation.ValidationController)), _dec3 = (0, _aureliaFramework.computedFrom)('validationController.errors.length'), _dec(_class = _dec2(_class = (_class2 = function () {
    ...
    EditUserController.prototype.startTracking = function startTracking(original) {
      ...
      if (original) {
        ...
        _aureliaValidation.ValidationRules.ensure('firstName').displayName('First Name').required().minLength(3).maxLength(25).ensure('lastName').displayName('Last Name').required().minLength(3).maxLength(25).ensure('email').displayName('Email').required().email().on(this.editable);
  ...
  var Users = exports.Users = (_dec = (0, _aureliaFramework.inject)(_server.Server, _aureliaRouter.Router, _commonDialogs.CommonDialogs, _editUserController.EditUserController), _dec2 = (0, _aureliaFramework.singleton)(), _dec(_class = _dec2(_class = function () {
    ...
    Users.prototype.canDeactivate = function canDeactivate() {
      if (this.controller.isDirty) {
        var message = 'You have made changes. If you leave now, they will be lost. Do you wish to continue?';
...
define('resources/dialogs/common-dialogs',['exports', 'aurelia-framework', 'aurelia-dialog', './message-box', './prompt'], function (exports, _aureliaFramework, _aureliaDialog, _messageBox, _prompt) {
  ...
  var CommonDialogs = exports.CommonDialogs = (_dec = (0, _aureliaFramework.inject)(_aureliaDialog.DialogService), _dec(_class = function () {
    ...
    CommonDialogs.prototype.prompt = function prompt(message) {
      var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Info Box';
...
define('resources/elements/line-chart',['exports', 'chartjs', 'aurelia-framework'], function (exports, _chartjs, _aureliaFramework) {
  'use strict';
  ...
  var LineChart = exports.LineChart = (_dec = (0, _aureliaFramework.children)('chart-data'), (_class = function () {
    function LineChart() {
      _classCallCheck(this, LineChart);

      _initDefineProp(this, 'labels', _descriptor, this);

      _initDefineProp(this, 'datasets', _descriptor2, this);
    }

    LineChart.prototype.bind = function bind() {
      this.context = this.canvas.getContext('2d');
    };

    LineChart.prototype.attached = function attached() {
      this.render();
    };
    ...
    LineChart.prototype.render = function render() {
      ...
      this.chart = new _chartjs2.default(this.context).Line(data);
    };

    LineChart.prototype.detached = function detached() {
      if (this.chart) {
        this.chart.destroy();
      }
    };
    ...
    return LineChart;
  }(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'labels', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'datasets', [_dec], {
    enumerable: true,
    initializer: null
  })), _class));
});
